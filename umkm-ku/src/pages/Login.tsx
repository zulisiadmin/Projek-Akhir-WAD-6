  ...
  <div className="d-flex flex-column justify-content-center align-items-center flex-grow-1 bg-white">
    ...
    <form className="d-flex flex-column gap-3" style={{width: '400px'}}>
      ...
      <div className="mb-3">
        ...
        <div id="emailHelp" className="form-text">Minimal 8 karakter</div>
      </div>
      ...
      <Link to="/" className="btn btn-danger px-5 py-2">Masuk</Link>
      <Link to="/" className="text-danger">Lupa Kata Sandi ?</Link>
      </div>
      <hr />
      <p className="text-center">Belum Punya Akun ? <Link to="/register" className="text-danger">Buat Akun</Link></p>
    </form>
  </div>
</div>
